...
week_folder <- "04-14_Srebro"


title <- "What do we mean by 'non-discriminatory' in statistical prediction tasks?"


speaker <- "Nathan Srebrol"
department <- "TTIC"
university <- "University of Chicago"
github_home <- "https://github.com/uchicago-computation-workshop"

#Update Weekly
issues_url <- "https://github.com/uchicago-computation-workshop/Spring2022/issues/3"


#Papers

week_paper_ref0 <- "Hardt, M., Price, E., & Srebro, N. (2016). Equality of opportunity in supervised learning. Advances in neural information processing systems, 29."
week_paper_file0 <- "srebro_reading.pdf"
