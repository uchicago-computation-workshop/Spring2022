...
week_folder <- "05-26_Soll"


title <- "Enhancing the Wisdom of Crowds"


speaker <- "Jack Soll"
department <- "Professor of Management and Organizations at Fuqua School of Business"
university <- "Duke University"
github_home <- "https://github.com/uchicago-computation-workshop"

#Update Weekly
#Update Weekly
issues_url <- "https://github.com/uchicago-computation-workshop/Spring2022/issues/8"

#Papers
week_paper_ref0 <- "Mannes, A. E., Soll, J. B., & Larrick, R. P. (2014). The wisdom of select crowds. Journal of Personality and Social Psychology, 107(2), 276–299."
week_paper_file0 <- "reading.pdf"
