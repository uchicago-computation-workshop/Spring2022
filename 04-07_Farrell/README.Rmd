...
#Update Weekly
issues_url <- "https://github.com/uchicago-computation-workshop/Spring2022/issues/2"


#Papers

week_paper_ref0 <- "Farrell, M. H., Liang, T., & Misra, S. (2020). Deep learning for individual heterogeneity: an automatic inference framework. arXiv preprint arXiv:2010.14694."
week_paper_file0 <- "farrell1.pdf"

week_paper_ref1 <- "Farrell, M. H., Liang, T., & Misra, S. (2021). Deep neural networks for estimation and inference. Econometrica, 89(1), 181-213."
week_paper_file1 <- "farrell2.pdf"
